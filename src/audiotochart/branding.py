...
LOGO = """     _             _ _     _____      ____ _                _   
    / \\  _   _  __| (_) __|_   _|__  / ___| |__   __ _ _ __| |_ 
   / _ \\| | | |/ _` | |/ _ \\| |/ _ \\| |   | '_ \\ / _` | '__| __|
  / ___ \\ |_| | (_| | | (_) | | (_) | |___| | | | (_| | |  | |_ 
 /_/   \\_\\__,_|\\__,_|_|\\___/|_|\\___/ \\____|_| |_|\\__,_|_|   \\__|
""".rstrip()


def print_branding(console: Console) -> None:
    """Render the AudioToChart logo for interactive terminal sessions."""
    ...
    if console.width < 92:
        console.print(
            Panel.fit(
                Text("AudioToChart", style="bold cyan"),
                border_style="cyan",
                box=box.ROUNDED,
                padding=(0, 1),
            )
