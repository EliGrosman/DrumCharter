...
picks peaks, and converts activations to :class:`~drumcharter.drums.DrumHit`
...
class ModelTranscriber:
    ...
    (see :func:`~drumcharter.inference.checkpoint.load_model_bundle`).
    ...
    def transcribe(self, audio_path: Path) -> list[DrumHit]:
        ...
        Returns:
            A list of :class:`~drumcharter.drums.DrumHit` objects sorted by time.
        ...
        if self._onset_decoder_dir is not None:
            ...
            if onsets:
                from drumcharter.inference.onset_decoder import refine_chord_onsets
    ...
    def _ensure_onset_decoder_loaded(self, bundle: ModelBundle) -> object:
        ...
        from drumcharter.inference.onset_decoder import load_chord_decoder_bundle
